...
1.  PENERIMA HIBAH JASA dengan ini memberikan izin kepada PEMBERI HIBAH JASA untuk menggunakan nama instansi, logo, tangkapan layar (*screenshot*) tampilan sistem, dan deskripsi singkat proyek sebagai bahan portofolio karya agensi, konten pemasaran digital (termasuk media sosial dan website resmi ibradigital.id), serta referensi profesional kepada calon klien lainnya.
