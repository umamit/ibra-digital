    ...
    >
      ...
      <footer className={styles.footer}>
        ...
        <div style={{ display: "flex", gap: "12px", justifyContent: "center", marginTop: "10px", fontSize: "0.88rem" }}>
          <a href="/terms" style={{ color: "var(--color-primary)", textDecoration: "none", fontWeight: "600" }}>Syarat & Ketentuan</a>
          <span style={{ color: "rgba(33, 108, 126, 0.3)" }}>|</span>
          <a href="/privacy" style={{ color: "var(--color-primary)", textDecoration: "none", fontWeight: "600" }}>Kebijakan Privasi</a>
        </div>
