...
**PENGEMBANGAN SISTEM & PEMBUATAN WEBSITE**
**IBRA DIGITAL ENGINEERING**

No. Kontrak: [____/IDE/KONTRAK/[BULAN]/[TAHUN]]
...
1.  **Nama**: [Nama Perwakilan IDE]
    **Jabatan**: [Jabatan, misal: Lead Architect / Direktur]
    **Instansi**: IBRA Digital Engineering
    **Alamat**: [Alamat Kantor IDE, Bobong, Pulau Taliabu, Maluku Utara]
    **Kontak**: +62 813-5700-1357
    Dalam hal ini bertindak untuk dan atas nama **IBRA Digital Engineering**, yang selanjutnya dalam perjanjian ini disebut sebagai **PIHAK PERTAMA (Penyedia Jasa)**.
...
| :---: | :---: |
| **IBRA Digital Engineering** | **[Nama Instansi/Perusahaan Klien]** |
| | |
| | |
| *Ttd & Materai Rp10.000* | *Ttd & Materai Rp10.000* |
| | |
| **([Nama Perwakilan IDE])** | **([Nama Lengkap Klien])** |
| [Jabatan] | [Jabatan] |
