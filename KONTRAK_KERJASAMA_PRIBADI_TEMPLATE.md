...
**PENGEMBANGAN SISTEM & PEMBUATAN WEBSITE (INDIVIDUAL)**

No. Kontrak: [____/AESU/KONTRAK/[BULAN]/[TAHUN]]

Pada hari ini, [Hari], tanggal [Tanggal] bulan [Bulan] tahun [Tahun] ([DD-MM-YYYY]), bertempat di Bobong, Pulau Taliabu, yang bertanda tangan di bawah ini:
...
1.  **Nama**: Anhar Ekho Sulasmin Umamit, S.T.
    ...
    **Kontak**: [Nomor HP/WhatsApp Anda]
    Dalam hal ini bertindak untuk dan atas nama pribadi selaku Penyedia Jasa Pengembangan Website Independen, yang selanjutnya dalam perjanjian ini disebut sebagai **PIHAK PERTAMA (Penyedia Jasa Perorangan)**.

2.  **Nama**: [Nama Lengkap Klien]
    **Jabatan**: [Jabatan Klien, misal: Kepala Sekolah / Pemilik Usaha]
    **Instansi**: [Nama Sekolah/Perusahaan Klien, misal: SD Negeri Bobong]
    **Alamat**: [Alamat Lengkap Klien]
    **Kontak**: [Nomor HP/WhatsApp Klien]
    Dalam hal ini bertindak untuk dan atas nama [Instansi/Perusahaan Klien], yang selanjutnya dalam perjanjian ini disebut sebagai **PIHAK KEDUA (Klien)**.

PIHAK PERTAMA dan PIHAK KEDUA secara bersama-sama disebut sebagai **PARA PIHAK**. PARA PIHAK sepakat untuk mengikatkan diri dalam Perjanjian Kerja Sama Pembuatan dan Pengembangan Sistem/Website dengan syarat dan ketentuan sebagai berikut:

---

### PASAL 1: RUANG LINGKUP PEKERJAAN
PIHAK PERTAMA bersedia melaksanakan dan menyelesaikan pekerjaan pembuatan sistem/website kepada PIHAK KEDUA dengan rincian spesifikasi sebagai berikut:
1.  **Nama Proyek**: Pembuatan [Nama Sistem/Website, misal: Portal PPDB & Rapor Digital]
2.  **Platform & Stack**: Next.js, Tailwind CSS v4, Supabase Cloud Database, dan integrasi WhatsApp Gateway.
3.  **Fitur Utama**:
    *   [Fitur 1, misal: Landing Page Premium berstandar Apple HIG]
    *   [Fitur 2, misal: Portal Manajemen Data & Form Input Dinamis]
    *   [Fitur 3, misal: Geofence GPS Attendance & Absensi Real-time]
    *   [Fitur 4, misal: Ekspor Dokumen Laporan format PDF/Excel]
4.  **Infrastruktur**: Pembelian/Pointing Domain ([domain_klien.id]), langganan Hosting (Vercel/Supabase Serverless), serta konfigurasi sertifikat keamanan SSL/HTTPS via Cloudflare.
...
4.  PIHAK PERTAMA berhak mencantumkan nama "Anhar Ekho Sulasmin Umamit, S.T." pada bagian footer website/sistem sebagai perancang resmi, kecuali disepakati lain oleh PARA PIHAK.
...
2.  Fasilitas garansi ini berlaku selama kerusakan bersumber dari kode awal pengerjaan PIHAK PERTAMA, dan **gugur** apabila kode utama diubah, dirusak, atau modifikasi oleh pihak ketiga tanpa persetujuan PIHAK PERTAMA.
...
| :---: | :---: |
| **Penyedia Jasa (Individu)** | **[Nama Instansi/Perusahaan Klien]** |
| | |
| | |
| *Ttd & Materai Rp10.000* | *Ttd & Materai Rp10.000* |
| | |
| **(Anhar Ekho Sulasmin Umamit, S.T.)** | **([Nama Lengkap Klien])** |
| Web Developer | [Jabatan] |
